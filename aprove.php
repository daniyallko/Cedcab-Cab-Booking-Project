  ...
  <h3 class="text-center">Pending/Blocked Users</h3>
    ...
    <table id="tbl" class="container-fluid col-lg-10 mr-lg-2 table table-responsive table-hover table-bordered table-striped">
        ...
        <?php 
            ...
            {
                echo "<tr><td>".$val['user_id']."</td><td>".$val['name']."</td><td>".$val['user_name']."</td><td>".$val['dateofsignup']."</td><td>".$val['mobile']."</td><td><a class='btn btn-success' href='aprove.php?action=yes&id=".$val['user_id']."'>Approve</a></td><td><a class='btn btn-danger' href='aprove.php?action=no&id=".$val['user_id']."'>Delete</a></td></tr>"; 
            }
             ?>
